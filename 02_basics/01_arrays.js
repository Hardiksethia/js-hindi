// array // see console log in browsers for prototype
...
// console.log(myArr[1]);
// arrays makes a shallow copy see documentation
...
// myArr.unshift(9)  (adds 9 at the start)
...
splice not includes last index value but it takes number of values given from starting index.....for ex: arr = [2,3,4,5,6,7,8,9] and then console.log(arr.splice(3,4)); gives 5,6,7,8.
